...
saver.restore(sess,'./saved_models-sunmeet/c2i-77200')
...
while epoch<epochs:
    ...
    if epoch%100==0:
        saver.save(sess,'./saved_models-sunmeet/c2i',global_step=epoch)
        ...
        plt.imsave(arr=gen_images[0],fname='./outputs-sunmeet/'+str(epoch)+'_gen.png')
        plt.imsave(arr=real_images[0],fname='./outputs-sunmeet/'+str(epoch)+'_gt.png')
