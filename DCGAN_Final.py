...
dataset=open('/home/SharedData/sunmeet/CUB/list.txt','r').read().splitlines() #List of all images
...
def generate_cub_batch(batch_size):
    ...
    for i in range(len(batch)):
        real_images[i]=plt.imread('/home/SharedData/sunmeet/CUB/images_64/'+batch[i]+'.png')
        sentence_list=np.load('/home/SharedData/sunmeet/CUB/encoded_captions/'+batch[i]+'.npy')
...
while epoch<=epochs:
    ...
    if epoch%100==0:
        saver.save(sess,'/home/SharedData/sunmeet/c2i/saved_model_stage1/c2i',global_step=epoch)
